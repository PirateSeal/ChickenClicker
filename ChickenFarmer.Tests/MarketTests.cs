...
//            farm.Buildings.Build<Market>(1, 2);
//            farm.Buildings.FindBuilding<Market>(1,2).BuyBuilding( 1, 1 );
...
//            Assert.That( farm.Buildings.BuildingList.Count(building => building is Henhouse), Is.EqualTo( 1 ) );
//        }
...
//            farm.Buildings.FindBuilding<Market>(1,1).BuyBuilding( 1, 2 );
...
//            farm.Buildings.FindBuilding<Market>(1,2).UpgradeBuilding(house);
